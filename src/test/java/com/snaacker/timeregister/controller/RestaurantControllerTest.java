...
public class RestaurantControllerTest extends FixtureTest {
  ...
  public void getAllRestaurantWithValidValueShouldReturnListRestaurant() {
    ...
    restaurantResponseList.add(new RestaurantResponse("restaurant1", "Hanoi", "email1", "123456"));
    restaurantResponseList.add(new RestaurantResponse("restaurant2", "Saigon", "email2", "123456"));
    restaurantResponseList.add(new RestaurantResponse("restaurant3", "Danang", "email3", "123456"));
  ...
  public void getRestaurantByIdWithValidValueShouldReturnCorrectObject() {
    ...
    ResponseEntity<RestaurantResponse> returnObject = restaurantController.getRestaurantById(1l);
